...
def build_parser():
    ...
    parser.add_argument('--content',dest='content',help='content image',metavar='CONTENT',default='4.jpg')
    parser.add_argument('--styles',dest='styles',help='one or more style images',metavar='STYLE',default='style.jpg')
    parser.add_argument('--network',dest='network',help='path to network parameters',metavar='VGG_PATH',default=network)
